/*******************************************************************************
 NovaBello Planetarium Dome INDI Driver

 Based on copy of Baaden Doe driver
...
// We declare an auto pointer to NovaBelloDome.
std::unique_ptr<NovaBelloDome> novaBelloDome(new NovaBelloDome());
...
{
    novaBelloDome->ISGetProperties(dev);
}

void ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
    novaBelloDome->ISNewSwitch(dev, name, states, names, n);
}

void ISNewText(const char *dev, const char *name, char *texts[], char *names[], int n)
{
    novaBelloDome->ISNewText(dev, name, texts, names, n);
}

void ISNewNumber(const char *dev, const char *name, double values[], char *names[], int n)
{
    novaBelloDome->ISNewNumber(dev, name, values, names, n);
}
...
{
    novaBelloDome->ISSnoopDevice(root);
}

NovaBelloDome::NovaBelloDome()
{
    targetAz         = 0;
...
bool NovaBelloDome::initProperties()
{
 ...
 *
* ***********************************************************************************/
const char *NovaBelloDome::getDefaultName()
{
    return (const char *)"NovaBello Dome";
}

/************************************************************************************
 *
* ***********************************************************************************/
bool NovaBelloDome::updateProperties()
{
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::ISNewSwitch(const char *dev, const char *name, ISState *states, char *names[], int n)
{
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::UpdateShutterStatus()
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char resp[DOME_BUF];
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::UpdatePosition()
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char resp[DOME_BUF];
 ...
 *
* ***********************************************************************************/
unsigned short NovaBelloDome::MountAzToDomeAz(double mountAz)
{
    int domeAz = 0;
 ...
 *
* ***********************************************************************************/
double NovaBelloDome::DomeAzToMountAz(unsigned short domeAz)
{
    double mountAz = 0;
 ...
 *
* ***********************************************************************************/
IPState NovaBelloDome::MoveAbs(double az)
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char cmd[DOME_BUF];
 ...
 *
* ***********************************************************************************/
IPState NovaBelloDome::MoveRel(double azDiff)
{
 ...
 *
* ***********************************************************************************/
IPState NovaBelloDome::ControlShutter(ShutterOperation operation)
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char cmd[DOME_BUF];
 ...
 *
* ***********************************************************************************/
const char *NovaBelloDome::GetFlapStatusString(FlapStatus status)
{
    switch (status)
    {
        case FLAP_OPENED:
 ...
 *
* ***********************************************************************************/
int NovaBelloDome::ControlDomeFlap(FlapOperation operation)
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char cmd[DOME_BUF];
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::UpdateFlapStatus()
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char resp[DOME_BUF];
    ...
    const std::string sGetSlotStat = DomeProtocolHandler::CreateStringGetSlotStatus();

    if (!sim && (rc = tty_write(PortFD, sGetSlotStat.c_str(), sGetSlotStat.length(), &nbytes_written)) != TTY_OK)
    {
        tty_error_msg(rc, errstr, MAXRBUF);
    ...
    /* org if (!sim && (rc = tty_write(PortFD, "d#getflap", DOME_CMD, &nbytes_written)) != TTY_OK)
    {
        tty_error_msg(rc, errstr, MAXRBUF);
        LOGF_ERROR("d#getflap UpdateflapStatus error: %s.", errstr);
        return false;
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::SaveEncoderPosition()
{
    int nbytes_written = 0, nbytes_read = 0, rc = -1;
    char errstr[MAXRBUF];
    char cmd[DOME_BUF];
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::saveConfigItems(FILE *fp)
{
 ...
 *
* ***********************************************************************************/
bool NovaBelloDome::SetCurrentPark()
{
...
bool NovaBelloDome::SetDefaultPark()
{
